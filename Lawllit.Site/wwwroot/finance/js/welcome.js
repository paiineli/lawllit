(function () {
    ...
    // A URL vem do Razor porque o site pode ser publicado sob um subcaminho,
    // e um caminho cravado aqui quebraria fora da raiz do dominio.
    var stepUrl = progressContainer.dataset.stepUrl;

    function goToStep(stepNumber) {
        window.location.href = stepUrl + '?step=' + stepNumber;
    }
