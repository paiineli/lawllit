(function () {
    ...
    var entrada = document.getElementById('sql-input');
    if (!entrada) return;

    var saida = document.getElementById('sql-output');
    var semRepetidos = document.getElementById('sql-dedupe');
    var comParenteses = document.getElementById('sql-parens');
    var botaoLimpar = document.getElementById('sql-clear');
