(function () {
    ...
    var entrada = document.getElementById('img-input');
    if (!entrada) return;

    var botoesNivel = document.querySelectorAll('[data-nivel]');
    var resultado = document.getElementById('img-result');
    var previa = document.getElementById('img-preview');
    var tamanhoOriginalTexto = document.getElementById('img-original');
    var tamanhoFinalTexto = document.getElementById('img-compressed');
    var reducaoTexto = document.getElementById('img-reduction');
    var botaoBaixar = document.getElementById('img-download');
