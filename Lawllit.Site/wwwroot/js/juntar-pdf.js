(function () {
    ...
    var entrada = document.getElementById('files-input');
    if (!entrada) return;

    var lista = document.getElementById('file-list');
    var botaoJuntar = document.getElementById('merge-btn');
    var formulario = botaoJuntar.closest('form');
    var cortina = document.getElementById('merge-overlay');
    var rotulo = document.getElementById('overlay-label');
    var barra = document.getElementById('overlay-progress');
