(function () {
    ...
    var entrada = document.getElementById('documento-entrada');
    if (!entrada) return;

    var saida = document.getElementById('documento-saida');
    var botaoLimpar = document.getElementById('documento-limpar');
    ...
    document.querySelectorAll('[data-documento]').forEach(function (botao) {
        botao.addEventListener('click', function () {
            var acao = acoes[botao.dataset.documento];
            if (acao) acao();
        });
    });
