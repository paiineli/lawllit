...
public class EmailService(IConfiguration config, ILogger<EmailService> logger, IStringLocalizerFactory localizerFactory, IHttpClientFactory httpClientFactory) : IEmailService
{
